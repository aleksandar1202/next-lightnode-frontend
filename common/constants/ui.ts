...
export const ARR_BLOGS: Array<LNSimpleBlogArgs> = [{
  ...
  noBorder: false,
  description: 'For users with greater than 32 Ethereum, LightNode Solo intends to make staking and running a personal validator as simple as possible without the difficulties of maintaining and operating your own server or hardware. Our semi-centralized approach provides users with greater security and convenience.'
}, {
  title: 'WHAT IS SLETH',
  btnTitle: 'Learn more',
  side: 'rtl',
  ...
  noBorder: false,
  description: 'slETH is a 1:1 ratio utility token which is given to a user who deposits Ethereum into LightNode Shared. Since this token is backed by liquidity, users may exchange their slETH back into Ethereum at any time. slETH may additionally be used for voting rights within LightNode DAO.'
}, {
  ...
  noBorder: false,
  description: 'Users who wish to participate in LightNode Liquidity Farm may do so by adding liquidity to the slETH/ETH pool. LightNode will begin with Uniswap and over time will begin to reach out to additional DeFi protocols.'
}, {
  title: 'ROADMAP',
  btnTitle: 'Learn more',
  side: 'rtl',
