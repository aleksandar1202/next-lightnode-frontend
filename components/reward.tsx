...
export const LNReward = ({
  ...
  return (<div className="w-full h-full py-20 px-12 border border-transparent hover:border hover:rounded-lg hover:border-gray duration-300">
      <Image src={imgSrc} width={66} height={66}/>
